...
public class MagicBox extends JPanel implements Runnable, MouseListener {
	...
	int z;
	JFrame frame;
	MediaPalace1 m = new MediaPalace1();
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (f.equals(frame)) {
			System.out.println("a" + backgroundImage.getRGB(e.getX(), e.getY()));
			z = backgroundImage.getRGB(e.getX(), e.getY());
		}
		if (z == 1056837) {
			m.loadImageFromWithinProject("orange.jpeg");
		}
	}
